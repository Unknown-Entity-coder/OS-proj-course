...
user/_clock:     file format elf64-littleriscv
...
main(void)
{
   ...
   8:	320000ef          	jal	ra,328 <uptime>
    int seconds = time / 10;  // Assuming ticks are 100ms each.
    printf("Uptime: %d seconds\n", seconds);
   c:	45a9                	li	a1,10
   e:	02b545bb          	divw	a1,a0,a1
  12:	00001517          	auipc	a0,0x1
  16:	83e50513          	addi	a0,a0,-1986 # 850 <malloc+0xe4>
  1a:	698000ef          	jal	ra,6b2 <printf>
    exit(0);
  1e:	4501                	li	a0,0
  20:	270000ef          	jal	ra,290 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38c:	4e850513          	addi	a0,a0,1256 # 870 <digits>
 390:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 452:	422c8c93          	addi	s9,s9,1058 # 870 <digits>
 ...
 65a:	21290913          	addi	s2,s2,530 # 868 <malloc+0xfc>
        for(; *s; s++)
