...
user/_testingtime:     file format elf64-littleriscv
...
int main(void) {
   ...
   6:	0800                	addi	s0,sp,16
	printf( "The year which the get year value is %d\n", time());  
   8:	328000ef          	jal	ra,330 <time>
   c:	85aa                	mv	a1,a0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38c:	50050513          	addi	a0,a0,1280 # 888 <digits>
 390:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 452:	43ac8c93          	addi	s9,s9,1082 # 888 <digits>
 ...
 65a:	22a90913          	addi	s2,s2,554 # 880 <malloc+0x114>
        for(; *s; s++)
